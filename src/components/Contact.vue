...
<template>
  <div class="contact_us_6">
    ...
    <h1 v-if="isShow" class="title">Contact</h1>
    <div class="responsive-container-block container">
      <form class="form-box">
        <div class="container-block form-wrapper">
          ...
          <button class="submit-btn" style="cursor: pointer">Submit</button>
        </div>
      </form>
      <div
      ...
      >
        <div class="map-part">
          ...
          <div class="map-box container-block">
            <img
              src="https://cdni.iconscout.com/illustration/premium/thumb/employees-working-on-project-2890213-2407190.png"
              alt=""
